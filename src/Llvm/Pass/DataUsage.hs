...
unionDataUsage (DataUsage s1 s2 s3 s4 s5 s6 s7 s8 s9 s10 s11 s12 s13 s14) 
  (DataUsage t1 t2 t3 t4 t5 t6 t7 t8 t9 t10 t11 t12 t13 t14) 
  = DataUsage 
    ...
    (s13 `S.union` t13) (s14 `S.union` t14)
