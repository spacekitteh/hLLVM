...
addStackAddrStoringPtrParam :: Lname -> DataUsage g -> DataUsage g
...
addStackAddrCaptured :: Lname -> DataUsage g -> DataUsage g
...
addStackAddrStoringPtr :: Lname -> DataUsage g -> DataUsage g
...
addStackAddrPassedToVaStart :: Lname -> DataUsage g -> DataUsage g
...
addStackAddrStoringValue :: Lname -> DataUsage g -> DataUsage g
...
addStackAddr :: Lname -> DataUsage g -> DataUsage g
...
addStackAddrInvolvingPtrArithm :: Lname -> DataUsage g -> DataUsage g
...
killLive :: Lname -> DataUsage g -> DataUsage g
...
filterAlloca :: Ord g => Lname -> (DataUsage g -> S.Set (Value g)) 
                -> (Lname -> DataUsage g -> DataUsage g) -> DataUsage g -> DataUsage g
...
propogateUpPtrUsage :: Ord g => Lname -> Value g -> DataUsage g -> DataUsage g
...
bwdScan :: forall g.forall a.forall m. (Show g, Ord g, Show a, DataUsageUpdator g a, H.FuelMonad m) => 
           S.Set Lname -> H.BwdPass m (Node g a) (DataUsage g)
bwdScan formalParams = H.BwdPass { H.bp_lattice = usageLattice
  ...
  where
    bwdTran :: (Show g, Ord g) => S.Set Lname -> Node g a e x -> H.Fact x (DataUsage g) -> DataUsage g
